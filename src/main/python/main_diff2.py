...
import AOC_coefficients_data_analysis_diff2 as AOC
import numpy as np
import os
import re
...
class AOCWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.aoc.ParExpName = 'diff-diff0' # 'par_avg'
        self.aoc.PerExpName = 'diff-diff0' #'per_avg'
        self.aoc.semPar = 'par_sem'
        self.aoc.semPer = 'per_sem'
